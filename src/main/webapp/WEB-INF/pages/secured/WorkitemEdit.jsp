...
<h1>Edit workitem page</h1>
<form:form method="POST" commandName="workitem" action="${pageContext.request.contextPath}/secured/workitem/edit/project=${idProject}
				&iteration=${idIteration}&workitem=${workitem.idWorkitem}&ref=${ref}.html" >
<table cellspacing="5">
	<tr>
		<td>Title</td>
	...
	<tr>
		...
		<td><form:hidden path="project" /></td>
	</tr>
</table>
</form:form>
